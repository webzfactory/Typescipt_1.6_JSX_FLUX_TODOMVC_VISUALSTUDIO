    ...
    var TodoActions = (function () {
        ...
        TodoActions.toggleComplete = function (todo) {
            var action = todo.IsComplete ?
                new AppDispatcher.Action(TodoConstants_1.default.TODO_COMPLETE, new TodoItemModel_1.default()) :
                new AppDispatcher.Action(TodoConstants_1.default.TODO_UNDO_COMPLETE, new TodoItemModel_1.default());
